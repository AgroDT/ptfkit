...
| --- | --- | --- | --- |
| calc_ptf_cosby1984_univariate | `specs/functions/calc_ptf_cosby1984_univariate.md` | ready-for-implementation | Extracted from Table 5 univariate regressions for a test pilot. |
...
- Review `specs/functions/calc_ptf_cosby1984_univariate.md`.
...
- Use the golden data embedded in `specs/functions/calc_ptf_cosby1984_univariate.md`.
