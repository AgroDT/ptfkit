...
| --- | --- | --- | --- |
| calc_ptf_jabro1992 | `specs/functions/calc_ptf_jabro1992.md` | ready-for-implementation | Extracted from equation (3). |
...
- Use the golden data embedded in `specs/functions/calc_ptf_jabro1992.md`.
