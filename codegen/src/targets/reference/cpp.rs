...
mod tests {
    ...
    fn documents_modules_functions_and_record_fields_from_compiled_sources() {
        ...
        assert!(page.contains("import ptfkit.example2;"));
        assert!(page.contains("**Exported namespace:** `ptfkit::example2`"));
        assert!(page.contains("## `ExampleResult`"));
        assert!(page.contains("| `first` | First result. (1) |"));
        assert!(page.contains("[[nodiscard]]\ninline double calc_ptf_example2_scalar"));
        assert!(page.contains("inline ExampleResult calc_ptf_example2_record"));
        assert!(page.contains("{#function-calc_ptf_example2_scalar}"));
        assert!(function_index.contains(
            "[`ptfkit::example2::calc_ptf_example2_scalar`](modules/example2.md#function-calc_ptf_example2_scalar)"
        ));
        assert!(page.contains("[PTF catalog page](../../../ptf-catalog/sources/example2.md)"));
    }
