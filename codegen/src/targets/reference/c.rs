...
mod tests {
    ...
    fn documents_headers_functions_and_record_fields_from_compiled_sources() {
        ...
        assert!(page.contains("## `example_result`"));
        assert!(page.contains("| `first` | First result. (1) |"));
        assert!(page.contains("static inline double calc_ptf_example2_scalar(double x, double y)"));
        assert!(page.contains("static inline example_result calc_ptf_example2_record"));
        assert!(page.contains("{#function-calc_ptf_example2_scalar}"));
        assert!(function_index.contains("headers/example2.md#function-calc_ptf_example2_scalar"));
