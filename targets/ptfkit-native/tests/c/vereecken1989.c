...
int main() {
    {
        const ptfkit_calc_ptf_vereecken1989_result result = calc_ptf_vereecken1989(52.14, 10.93, 1.03, 1.466);
    ...
    {
        const ptfkit_calc_ptf_vereecken1989_detailed_result result = calc_ptf_vereecken1989_detailed(0.25, 0.88, 13.53, 21.15, 16.3, 24.83, 7.0, 5.15, 10.93, 0.07, 4.07, 1.03, 1.466);
