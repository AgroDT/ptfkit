...
int main() {
    {
        const ptfkit_calc_ptf_cosby1984_univariate_result result = calc_ptf_cosby1984_univariate(50.0, 30.0, 20.0);
    ...
    {
        const ptfkit_calc_ptf_cosby1984_univariate_result result = calc_ptf_cosby1984_univariate(80.0, 15.0, 5.0);
