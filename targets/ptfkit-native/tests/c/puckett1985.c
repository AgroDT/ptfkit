...
int main() {
    {
        ...
        assert_close(result.theta_0, 0.34288, 0.001, 0.0, "volumetric_water_content",
                     "volume_fraction", "registry", "cahaba_ap");
        assert_close(result.theta_1, 0.33926, 0.001, 0.0, "volumetric_water_content",
                     "volume_fraction", "registry", "cahaba_ap");
        assert_close(result.theta_5, 0.3938615, 0.001, 0.0, "volumetric_water_content",
                     "volume_fraction", "registry", "cahaba_ap");
