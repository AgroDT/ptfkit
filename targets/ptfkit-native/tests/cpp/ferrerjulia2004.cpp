...
int main() {
    {
        ...
        assert_close(result, 0.025071690110308933, 0.0001, 0.01, "saturated_hydraulic_conductivity",
                     "millimeter_per_hour", "registry", "reviewer_reference_vector");
    }
    {
        ...
        assert_close(result, 0.00022673430784327228, 0.0001, 0.01,
                     "saturated_hydraulic_conductivity", "millimeter_per_hour", "registry",
    ...
    }
    {
        const auto result =
            ptfkit::ferrerjulia2004::calc_ptf_ferrerjulia2004_humic_acrisol_texture_organic_matter(
                50.0, 25.0, 2.5);
        assert_close(result, 19.563475, 0.0001, 0.01, "saturated_hydraulic_conductivity",
                     "millimeter_per_hour", "registry", "reviewer_reference_vector");
    }
    {
        const auto result =
    ...
    }
    {
        ...
        assert_close(result, 16.51625, 0.0001, 0.01, "saturated_hydraulic_conductivity",
                     "millimeter_per_hour", "registry", "reviewer_reference_vector");
    }
    {
        const auto result =
    ...
    }
    {
        ...
        assert_close(result, 20.79, 0.0001, 0.01, "saturated_hydraulic_conductivity",
                     "millimeter_per_hour", "registry", "reviewer_reference_vector");
    }
    {
        const auto result =
    ...
    }
    {
        ...
        assert_close(result, 19.5235, 0.0001, 0.01, "saturated_hydraulic_conductivity",
                     "millimeter_per_hour", "registry", "reviewer_reference_vector");
    }
    {
        const auto result =
    ...
    }
    {
        ...
        assert_close(result, 11.514, 0.0001, 0.01, "saturated_hydraulic_conductivity",
                     "millimeter_per_hour", "registry", "reviewer_reference_vector");
    }
    {
        const auto result =
    ...
    }
    {
        const auto result =
            ptfkit::ferrerjulia2004::calc_ptf_ferrerjulia2004_humic_cambisol_texture_organic_matter(
                50.0, 25.0, 2.5);
        assert_close(result, 20.9029, 0.0001, 0.01, "saturated_hydraulic_conductivity",
                     "millimeter_per_hour", "registry", "reviewer_reference_vector");
    }
    {
        const auto result =
    ...
    }
    {
        ...
        assert_close(result, 13.101, 0.0001, 0.01, "saturated_hydraulic_conductivity",
                     "millimeter_per_hour", "registry", "reviewer_reference_vector");
    }
    {
        const auto result =
    ...
    }
    {
        const auto result =
            ptfkit::ferrerjulia2004::calc_ptf_ferrerjulia2004_calcic_luvisol_texture_organic_matter(
                50.0, 25.0, 2.5);
        assert_close(result, 8.9332, 0.0001, 0.01, "saturated_hydraulic_conductivity",
                     "millimeter_per_hour", "registry", "reviewer_reference_vector");
    }
    {
        const auto result =
    ...
    }
    {
        ...
        assert_close(result, 17.1465, 0.0001, 0.01, "saturated_hydraulic_conductivity",
                     "millimeter_per_hour", "registry", "reviewer_reference_vector");
    }
    {
        const auto result =
    ...
    }
    {
        const auto result =
            ptfkit::ferrerjulia2004::calc_ptf_ferrerjulia2004_gleyic_luvisol_texture_organic_matter(
                50.0, 25.0, 2.5);
        assert_close(result, 19.55, 0.0001, 0.01, "saturated_hydraulic_conductivity",
                     "millimeter_per_hour", "registry", "reviewer_reference_vector");
    }
    {
        const auto result =
    ...
    }
    {
        const auto result =
            ptfkit::ferrerjulia2004::calc_ptf_ferrerjulia2004_orthic_luvisol_texture_organic_matter(
                50.0, 25.0, 2.5);
        assert_close(result, 21.40425, 0.0001, 0.01, "saturated_hydraulic_conductivity",
                     "millimeter_per_hour", "registry", "reviewer_reference_vector");
    }
    {
    ...
    }
    {
        const auto result =
            ptfkit::ferrerjulia2004::calc_ptf_ferrerjulia2004_ranker_texture_organic_matter(
                50.0, 25.0, 2.5);
        assert_close(result, 22.4515, 0.0001, 0.01, "saturated_hydraulic_conductivity",
                     "millimeter_per_hour", "registry", "reviewer_reference_vector");
    }
    {
        const auto result =
    ...
    }
    {
        ...
        assert_close(result, 20.532, 0.0001, 0.01, "saturated_hydraulic_conductivity",
                     "millimeter_per_hour", "registry", "reviewer_reference_vector");
    }
    {
        const auto result =
    ...
    }
    {
        ...
        assert_close(result, 17.1335, 0.0001, 0.01, "saturated_hydraulic_conductivity",
                     "millimeter_per_hour", "registry", "reviewer_reference_vector");
    }
    {
        const auto result =
    ...
    }
    {
        const auto result =
            ptfkit::ferrerjulia2004::calc_ptf_ferrerjulia2004_eutric_regosol_texture_organic_matter(
                50.0, 25.0, 2.5);
        assert_close(result, 24.06375, 0.0001, 0.01, "saturated_hydraulic_conductivity",
                     "millimeter_per_hour", "registry", "reviewer_reference_vector");
    }
    {
    ...
    }
    {
        const auto result =
            ptfkit::ferrerjulia2004::calc_ptf_ferrerjulia2004_rendzina_texture_organic_matter(
                50.0, 25.0, 2.5);
        assert_close(result, 16.2905, 0.0001, 0.01, "saturated_hydraulic_conductivity",
                     "millimeter_per_hour", "registry", "reviewer_reference_vector");
    }
    {
        const auto result =
    ...
    }
    {
        ...
        assert_close(result, 10.53583, 0.0001, 0.01, "saturated_hydraulic_conductivity",
                     "millimeter_per_hour", "registry", "reviewer_reference_vector");
    }
    {
    ...
    }
    {
        const auto result =
            ptfkit::ferrerjulia2004::calc_ptf_ferrerjulia2004_general_texture_organic_matter(
                50.0, 25.0, 2.5);
        assert_close(result, 20.06325, 0.0001, 0.01, "saturated_hydraulic_conductivity",
                     "millimeter_per_hour", "registry", "reviewer_reference_vector");
    }
    return 0;
}
