...
int main() {
    {
        ...
        assert_close(result.theta_0, 46.54495, 0.1, 0.0, "volumetric_water_content",
                     "volume_percent", "registry", "representative_review_case");
        ...
        assert_close(result.pf_star, 3.62445, 0.001, 0.0, "varallyai_pf_star", "dimensionless",
                     "registry", "representative_review_case");
    }
    {
        const auto result = ptfkit::varallyai1982::calc_ptf_varallyai1982_chernozem_a(1.4, 0.35);
        static_assert(std::is_same_v<std::remove_cv_t<decltype(result)>,
                                     ptfkit::varallyai1982::Varallyai1982Parameters>);
        assert_close(result.theta_0, 52.005, 0.1, 0.0, "volumetric_water_content", "volume_percent",
                     "registry", "representative_review_case");
    ...
    }
    {
        ...
        static_assert(std::is_same_v<std::remove_cv_t<decltype(result)>,
                                     ptfkit::varallyai1982::Varallyai1982Parameters>);
        assert_close(result.theta_0, 47.60035, 0.1, 0.0, "volumetric_water_content",
                     "volume_percent", "registry", "representative_review_case");
    ...
    }
    {
        ...
        static_assert(std::is_same_v<std::remove_cv_t<decltype(result)>,
                                     ptfkit::varallyai1982::Varallyai1982Parameters>);
        assert_close(result.theta_0, 49.87, 0.1, 0.0, "volumetric_water_content", "volume_percent",
                     "registry", "representative_review_case");
