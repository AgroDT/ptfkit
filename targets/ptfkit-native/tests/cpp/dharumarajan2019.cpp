...
int main() {
    {
        const auto result = ptfkit::dharumarajan2019::calc_ptf_dharumarajan2019_nkp(43.20000000000000284, 39.79999999999999716, 33.60000000000000142);
        static_assert(std::is_same_v<std::remove_cv_t<decltype(result)>, ptfkit::dharumarajan2019::Dharumarajan2019WaterRetentionResult>);
    ...
    {
        const auto result = ptfkit::dharumarajan2019::calc_ptf_dharumarajan2019_nkp_clay(43.20000000000000284);
        static_assert(std::is_same_v<std::remove_cv_t<decltype(result)>, ptfkit::dharumarajan2019::Dharumarajan2019WaterRetentionResult>);
    ...
    {
        const auto result = ptfkit::dharumarajan2019::calc_ptf_dharumarajan2019_skp(31.50000000000000000, 53.50000000000000000, 14.69999999999999929);
        static_assert(std::is_same_v<std::remove_cv_t<decltype(result)>, ptfkit::dharumarajan2019::Dharumarajan2019WaterRetentionResult>);
    ...
    {
        const auto result = ptfkit::dharumarajan2019::calc_ptf_dharumarajan2019_skp_clay(31.50000000000000000);
        static_assert(std::is_same_v<std::remove_cv_t<decltype(result)>, ptfkit::dharumarajan2019::Dharumarajan2019WaterRetentionResult>);
    ...
    {
        const auto result = ptfkit::dharumarajan2019::calc_ptf_dharumarajan2019_infiltration(50.00000000000000000, 20.00000000000000000, 30.00000000000000000);
