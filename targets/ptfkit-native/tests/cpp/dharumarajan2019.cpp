...
int main() {
    {
        const auto result = ptfkit::dharumarajan2019::calc_ptf_dharumarajan2019_nkp(43.2, 39.8, 33.6);
    ...
    {
        const auto result = ptfkit::dharumarajan2019::calc_ptf_dharumarajan2019_skp(31.5, 53.5, 14.7);
        static_assert(std::is_same_v<std::remove_cv_t<decltype(result)>, ptfkit::dharumarajan2019::Dharumarajan2019WaterRetentionResult>);
    ...
    {
        const auto result = ptfkit::dharumarajan2019::calc_ptf_dharumarajan2019_infiltration(50.0, 20.0, 30.0);
