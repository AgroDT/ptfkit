...
int main() {
    {
        ...
        assert_close(result, 0.0000005103578, 0.0000000001, 0.01,
                     ...
                     "igp_saturated_conductivity_case");
    }
    {
        const auto result =
        ...
        assert_close(result.w_33, 41.1729, 0.1, 0.0, "gravimetric_water_content", "mass_percent",
                     "registry", "black_soil_compatibility_case");
        assert_close(result.w_100, 36.8273, 0.1, 0.0, "gravimetric_water_content", "mass_percent",
                     "registry", "black_soil_compatibility_case");
        assert_close(result.w_1500, 21.6976, 0.1, 0.0, "gravimetric_water_content", "mass_percent",
                     "registry", "black_soil_compatibility_case");
        assert_close(result.k_sat, 0.000005373367, 0.0000000001, 0.01,
                     "saturated_hydraulic_conductivity", "meter_per_second", "registry",
                     "black_soil_compatibility_case");
    }
    return 0;
}
