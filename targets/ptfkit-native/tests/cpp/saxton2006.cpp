...
int main() {
    {
        ...
        assert_close(result.conductivity_lambda, 0.18776158355467926, 0.001, 0.0,
                     "conductivity_shape_parameter", "dimensionless", "registry", "table_3_sand");
        ...
        assert_close(result.normal_density, 1.4264356197312436, 0.001, 0.0, "dry_bulk_density",
                     "gram_per_cubic_centimeter", "registry", "table_3_sand");
    }
    {
        ...
        assert_close(result.adjusted_density, 1.569079181704368, 0.001, 0.0, "dry_bulk_density",
                     "gram_per_cubic_centimeter", "registry", "table_3_sand_compacted");
        assert_close(result.adjusted_theta_s, 0.407894648413446, 0.001, 0.0,
                     "volumetric_water_content", "volume_fraction", "registry",
    ...
    }
    {
        ...
        assert_close(result, 159.18094591362183, 0.01, 0.0, "matric_potential", "kilopascal",
    ...
    }
    {
        ...
        assert_close(result, 24.227216407352152, 0.01, 0.0, "matric_potential", "kilopascal",
    ...
    }
    {
        ...
        assert_close(result, 0.3003203142764693, 0.0001, 0.01, "unsaturated_hydraulic_conductivity",
                     "millimeter_per_hour", "registry", "table_3_sand_theta_0_3");
    }
    {
        ...
        assert_close(result.gravel_volume_fraction, 0.11860834455314037, 0.001, 0.0,
                     "gravel_volume_fraction", "volume_fraction", "registry",
                     "table_3_sand_twenty_percent_gravel");
        assert_close(result.bulk_density, 1.5715605653291098, 0.001, 0.0, "dry_bulk_density",
                     "gram_per_cubic_centimeter", "registry", "table_3_sand_twenty_percent_gravel");
    ...
    }
    {
        ...
        assert_close(result.saturated_osmotic_potential, 144.0, 0.01, 0.0, "osmotic_potential",
                     "kilopascal", "registry", "saline_partly_saturated_soil");
