 ...
 */
static inline ptfkit_calc_ptf_puckett1985_result calc_ptf_puckett1985(double sand, double fine_sand, double clay, double bulk_density, double porosity) {
    ...
    #ifdef __cplusplus
    return ptfkit_calc_ptf_puckett1985_result{theta_0, theta_1, theta_5, theta_10, theta_30, theta_60, theta_100, theta_500, theta_1000, theta_1500, k_sat};
#else
