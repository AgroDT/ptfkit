...
static inline wang2012_ptf_result calc_ptf_wang2012(double sand, double silt, double clay,
    ...
    const double log10_k_sat_cm_per_day = 1.173 + 0.038 * silt + 0.690 * log10_sand + 0.865 / sand -
    ...
    const double fc_percent =
        46.481 - 4.757 * soil_organic_carbon_g_per_kg - 14.028 * log10(clay) - 13.991 * log10_sand +
        42.261 * log10(soil_organic_carbon_g_per_kg) - 11.763 / sand +
