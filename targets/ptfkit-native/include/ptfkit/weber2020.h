 ...
 */
static inline ptfkit_calc_ptf_weber2020_result calc_ptf_weber2020(double theta_r_vgm, double theta_s_vgm, double alpha_vgm, double n_vgm, double tau_vgm, double k_s_vgm) {
    ...
    #ifdef __cplusplus
    return ptfkit_calc_ptf_weber2020_result{theta_snc_bw, theta_sc_bw, alpha_bw, n_bw, tau_bw, k_sc_bw, k_snc_bw};
#else
