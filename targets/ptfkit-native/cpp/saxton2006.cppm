...
export module ptfkit.saxton2006;
...
inline Saxton2006PTFResult calc_ptf_saxton2006(double sand, double clay, double organic_matter) {
    ...
    return Saxton2006PTFResult{theta_1500,
                               theta_33,
                               theta_s,
...
inline Saxton2006DensityResult calc_ptf_saxton2006_density(double normal_density, double theta_s,
    ...
    const double adjusted_theta_s_minus_33 = std::fmax(adjusted_theta_s - adjusted_theta_33, 0.005);
    return Saxton2006DensityResult{adjusted_density, adjusted_theta_s, adjusted_theta_33,
...
inline double calc_ptf_saxton2006_conductivity(double theta, double theta_s,
                                               double saturated_conductivity,
                                               double conductivity_lambda) {
    return saturated_conductivity * std::pow(theta / theta_s, 3.0 + 2.0 / conductivity_lambda);
}
...
calc_ptf_saxton2006_gravel(double gravel_weight_fraction, double matric_density,
    ...
    return Saxton2006GravelResult{gravel_volume_fraction, bulk_density, bulk_plant_available_water,
...
inline Saxton2006SalinityResult calc_ptf_saxton2006_salinity(double electrical_conductivity,
    ...
    return Saxton2006SalinityResult{saturated_osmotic_potential, osmotic_potential};
}
