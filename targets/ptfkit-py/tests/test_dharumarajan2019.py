...
CASES_CALC_PTF_DHARUMARAJAN2019_NKP_IDS = [
    'northern_study_mean_case',
]
...
@pytest.mark.parametrize(
    ('inputs', 'expected'),
    CASES_CALC_PTF_DHARUMARAJAN2019_NKP,
    ids=CASES_CALC_PTF_DHARUMARAJAN2019_NKP_IDS,
)
...
CASES_CALC_PTF_DHARUMARAJAN2019_NKP_CLAY_IDS = [
...
@pytest.mark.parametrize(
    ('inputs', 'expected'),
    CASES_CALC_PTF_DHARUMARAJAN2019_NKP_CLAY,
    ids=CASES_CALC_PTF_DHARUMARAJAN2019_NKP_CLAY_IDS,
)
...
CASES_CALC_PTF_DHARUMARAJAN2019_SKP_IDS = [
    'southern_study_mean_case',
]
...
@pytest.mark.parametrize(
    ('inputs', 'expected'),
    CASES_CALC_PTF_DHARUMARAJAN2019_SKP,
    ids=CASES_CALC_PTF_DHARUMARAJAN2019_SKP_IDS,
)
...
CASES_CALC_PTF_DHARUMARAJAN2019_SKP_CLAY_IDS = [
    'southern_study_mean_clay_case',
]
...
CASES_CALC_PTF_DHARUMARAJAN2019_INFILTRATION_IDS = [
    'balanced_texture_case',
]
