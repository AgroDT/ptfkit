...
CASES_CALC_PTF_SAXTON2006_IDS = [
    'table_3_sand',
]


@pytest.mark.parametrize(
    ('inputs', 'expected'), CASES_CALC_PTF_SAXTON2006, ids=CASES_CALC_PTF_SAXTON2006_IDS
)
...
CASES_CALC_DENSITY_ADJUSTMENT_SAXTON2006_IDS = [
    'table_3_sand_compacted',
]
...
@pytest.mark.parametrize(
    ('inputs', 'expected'),
    CASES_CALC_DENSITY_ADJUSTMENT_SAXTON2006,
    ids=CASES_CALC_DENSITY_ADJUSTMENT_SAXTON2006_IDS,
)
...
CASES_CALC_TENSION_DRY_SAXTON2006_IDS = [
    'table_3_sand_midpoint',
]
...
@pytest.mark.parametrize(
    ('inputs', 'expected'),
    CASES_CALC_TENSION_DRY_SAXTON2006,
    ids=CASES_CALC_TENSION_DRY_SAXTON2006_IDS,
)
...
CASES_CALC_TENSION_WET_SAXTON2006_IDS = [
    'table_3_sand_theta_0_2',
]
...
@pytest.mark.parametrize(
    ('inputs', 'expected'),
    CASES_CALC_TENSION_WET_SAXTON2006,
    ids=CASES_CALC_TENSION_WET_SAXTON2006_IDS,
)
...
CASES_CALC_CONDUCTIVITY_SAXTON2006_IDS = [
    'table_3_sand_theta_0_3',
]
...
CASES_CALC_GRAVEL_ADJUSTMENT_SAXTON2006_IDS = [
...
@pytest.mark.parametrize(
    ('inputs', 'expected'),
    CASES_CALC_GRAVEL_ADJUSTMENT_SAXTON2006,
    ids=CASES_CALC_GRAVEL_ADJUSTMENT_SAXTON2006_IDS,
)
...
CASES_CALC_OSMOTIC_POTENTIAL_SAXTON2006_IDS = [
    'saline_partly_saturated_soil',
]
...
@pytest.mark.parametrize(
    ('inputs', 'expected'),
    CASES_CALC_OSMOTIC_POTENTIAL_SAXTON2006,
    ids=CASES_CALC_OSMOTIC_POTENTIAL_SAXTON2006_IDS,
)
