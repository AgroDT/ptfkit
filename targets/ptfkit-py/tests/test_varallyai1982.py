...
CASES_CALC_PTF_VARALLYAI1982_MEADOW_IDS = [
...
@pytest.mark.parametrize(
    ('inputs', 'expected'),
    CASES_CALC_PTF_VARALLYAI1982_MEADOW,
    ids=CASES_CALC_PTF_VARALLYAI1982_MEADOW_IDS,
)
...
CASES_CALC_PTF_VARALLYAI1982_CHERNOZEM_A_IDS = [
    'representative_review_case',
]
...
@pytest.mark.parametrize(
    ('inputs', 'expected'),
    CASES_CALC_PTF_VARALLYAI1982_CHERNOZEM_A,
    ids=CASES_CALC_PTF_VARALLYAI1982_CHERNOZEM_A_IDS,
)
...
CASES_CALC_PTF_VARALLYAI1982_CHERNOZEM_B_IDS = [
    'representative_review_case',
]
...
@pytest.mark.parametrize(
    ('inputs', 'expected'),
    CASES_CALC_PTF_VARALLYAI1982_CHERNOZEM_B,
    ids=CASES_CALC_PTF_VARALLYAI1982_CHERNOZEM_B_IDS,
)
...
CASES_CALC_PTF_VARALLYAI1982_CHERNOZEM_C_IDS = [
    'representative_review_case',
]
