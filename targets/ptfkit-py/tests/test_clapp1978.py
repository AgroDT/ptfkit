...
@pytest.mark.parametrize(
    ('inputs', 'expected'), CASES_CALC_PTF_CLAPP1978, ids=CASES_CALC_PTF_CLAPP1978_IDS
)
def test_calc_ptf_clapp1978_verification(inputs: dict[str, object], expected: dict[str, float]):
    ...
    assert_close(
        ...
        relative=0.01,
        quantity='sorptivity',
        unit='centimeter_per_square_root_minute',
        source='registry',
    )
