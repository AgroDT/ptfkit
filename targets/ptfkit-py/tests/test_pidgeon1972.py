...
CASES_CALC_PTF_PIDGEON1972_FC_IDS = [
    'regression_case',
]
...
CASES_CALC_PTF_PIDGEON1972_FC_SAND_IDS = [
    'regression_case',
]
...
@pytest.mark.parametrize(
    ('inputs', 'expected'),
    CASES_CALC_PTF_PIDGEON1972_FC_SAND,
    ids=CASES_CALC_PTF_PIDGEON1972_FC_SAND_IDS,
)
...
CASES_CALC_PTF_PIDGEON1972_FC_SAND_ORGANIC_MATTER_IDS = [
    'regression_case',
]
...
@pytest.mark.parametrize(
    ('inputs', 'expected'),
    CASES_CALC_PTF_PIDGEON1972_FC_SAND_ORGANIC_MATTER,
    ids=CASES_CALC_PTF_PIDGEON1972_FC_SAND_ORGANIC_MATTER_IDS,
)
...
CASES_CALC_PTF_PIDGEON1972_FC_VOL_SAND_ORGANIC_MATTER_IDS = [
    'regression_case',
]
...
@pytest.mark.parametrize(
    ('inputs', 'expected'),
    CASES_CALC_PTF_PIDGEON1972_FC_VOL_SAND_ORGANIC_MATTER,
    ids=CASES_CALC_PTF_PIDGEON1972_FC_VOL_SAND_ORGANIC_MATTER_IDS,
)
...
CASES_CALC_PTF_PIDGEON1972_PWP_IDS = [
    'regression_case',
]
...
CASES_CALC_PTF_PIDGEON1972_PWP_SAND_IDS = [
    'regression_case',
]
...
@pytest.mark.parametrize(
    ('inputs', 'expected'),
    CASES_CALC_PTF_PIDGEON1972_PWP_SAND,
    ids=CASES_CALC_PTF_PIDGEON1972_PWP_SAND_IDS,
)
...
CASES_CALC_PTF_PIDGEON1972_PWP_SAND_ORGANIC_MATTER_IDS = [
    'regression_case',
]
...
@pytest.mark.parametrize(
    ('inputs', 'expected'),
    CASES_CALC_PTF_PIDGEON1972_PWP_SAND_ORGANIC_MATTER,
    ids=CASES_CALC_PTF_PIDGEON1972_PWP_SAND_ORGANIC_MATTER_IDS,
)
...
CASES_CALC_PTF_PIDGEON1972_AWC_IDS = [
    'regression_case',
]
...
CASES_CALC_PTF_PIDGEON1972_AWC_SAND_ORGANIC_MATTER_IDS = [
    'regression_case',
]
...
@pytest.mark.parametrize(
    ('inputs', 'expected'),
    CASES_CALC_PTF_PIDGEON1972_AWC_SAND_ORGANIC_MATTER,
    ids=CASES_CALC_PTF_PIDGEON1972_AWC_SAND_ORGANIC_MATTER_IDS,
)
...
CASES_CALC_PTF_PIDGEON1972_AWC_COARSE_SAND_IDS = [
    'regression_case',
]
...
@pytest.mark.parametrize(
    ('inputs', 'expected'),
    CASES_CALC_PTF_PIDGEON1972_AWC_COARSE_SAND,
    ids=CASES_CALC_PTF_PIDGEON1972_AWC_COARSE_SAND_IDS,
)
...
CASES_CALC_PTF_PIDGEON1972_AWC_FINE_SAND_IDS = [
    'regression_case',
]
...
@pytest.mark.parametrize(
    ('inputs', 'expected'),
    CASES_CALC_PTF_PIDGEON1972_AWC_FINE_SAND,
    ids=CASES_CALC_PTF_PIDGEON1972_AWC_FINE_SAND_IDS,
)
...
CASES_CALC_PTF_PIDGEON1972_AWC_VERY_FINE_SAND_IDS = [
    'regression_case',
]
...
@pytest.mark.parametrize(
    ('inputs', 'expected'),
    CASES_CALC_PTF_PIDGEON1972_AWC_VERY_FINE_SAND,
    ids=CASES_CALC_PTF_PIDGEON1972_AWC_VERY_FINE_SAND_IDS,
)
...
CASES_CALC_PTF_PIDGEON1972_EAWC_IDS = [
    'regression_case',
]


@pytest.mark.parametrize(
    ('inputs', 'expected'), CASES_CALC_PTF_PIDGEON1972_EAWC, ids=CASES_CALC_PTF_PIDGEON1972_EAWC_IDS
)
...
CASES_CALC_PTF_PIDGEON1972_EAWC_SAND_IDS = [
    'regression_case',
]
...
@pytest.mark.parametrize(
    ('inputs', 'expected'),
    CASES_CALC_PTF_PIDGEON1972_EAWC_SAND,
    ids=CASES_CALC_PTF_PIDGEON1972_EAWC_SAND_IDS,
)
...
CASES_CALC_PTF_PIDGEON1972_EAWC_SAND_ORGANIC_MATTER_IDS = [
    'regression_case',
]
...
@pytest.mark.parametrize(
    ('inputs', 'expected'),
    CASES_CALC_PTF_PIDGEON1972_EAWC_SAND_ORGANIC_MATTER,
    ids=CASES_CALC_PTF_PIDGEON1972_EAWC_SAND_ORGANIC_MATTER_IDS,
)
...
@pytest.mark.parametrize(
    ('inputs', 'expected'),
    CASES_CALC_PTF_PIDGEON1972_EAWC_COARSE_SAND_ORGANIC_MATTER,
    ids=CASES_CALC_PTF_PIDGEON1972_EAWC_COARSE_SAND_ORGANIC_MATTER_IDS,
)
...
CASES_CALC_PTF_PIDGEON1972_EAWC_FINE_SAND_ORGANIC_MATTER_IDS = [
    'regression_case',
]
...
@pytest.mark.parametrize(
    ('inputs', 'expected'),
    CASES_CALC_PTF_PIDGEON1972_EAWC_FINE_SAND_ORGANIC_MATTER,
    ids=CASES_CALC_PTF_PIDGEON1972_EAWC_FINE_SAND_ORGANIC_MATTER_IDS,
)
