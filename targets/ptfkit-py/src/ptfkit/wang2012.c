...
static void calc_ptf_wang2012_loop(char **args, const npy_intp *dimensions, const npy_intp *steps,
                                   void *data) {
    npy_intp index;
...
static char calc_ptf_wang2012_types[] = {NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE,
                                         NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE};

int ptfkit_register_wang2012(PyObject *module) {
    if (ptfkit_add_ufunc(module, "calc_ptf_wang2012", calc_ptf_wang2012_functions,
                         calc_ptf_wang2012_types, 6, 3) < 0)
        return -1;
    return 0;
}
