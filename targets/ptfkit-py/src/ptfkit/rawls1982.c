...
static void calc_ptf_rawls1982_theta_1500_loop(char **args, const npy_intp *dimensions,
...
static PyUFuncGenericFunction calc_ptf_rawls1982_theta_1500_functions[] = {
    calc_ptf_rawls1982_theta_1500_loop};
static char calc_ptf_rawls1982_theta_1500_types[] = {NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE};

static void calc_ptf_rawls1982_theta_33_loop(char **args, const npy_intp *dimensions,
                                             const npy_intp *steps, void *data) {
    npy_intp index;
    for (index = 0; index < dimensions[0]; index++) {
...
static PyUFuncGenericFunction calc_ptf_rawls1982_theta_33_functions[] = {
    calc_ptf_rawls1982_theta_33_loop};
static char calc_ptf_rawls1982_theta_33_types[] = {NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE};

static void calc_ptf_rawls1982_full_wrc_loop(char **args, const npy_intp *dimensions,
                                             const npy_intp *steps, void *data) {
    npy_intp index;
    for (index = 0; index < dimensions[0]; index++) {
        const double sand = *(const double *)args[0];
        ...
        const double theta_60 =
            0.0136 - 0.0091 * bulk_density + 0.66 * theta_33 + 0.39 * theta_1500;
...
static PyUFuncGenericFunction calc_ptf_rawls1982_full_wrc_functions[] = {
    calc_ptf_rawls1982_full_wrc_loop};
static char calc_ptf_rawls1982_full_wrc_types[] = {
...
int ptfkit_register_rawls1982(PyObject *module) {
    if (ptfkit_add_ufunc(module, "calc_ptf_rawls1982_theta_1500",
                         calc_ptf_rawls1982_theta_1500_functions,
                         calc_ptf_rawls1982_theta_1500_types, 2, 1) < 0)
        return -1;
    if (ptfkit_add_ufunc(module, "calc_ptf_rawls1982_theta_33",
                         calc_ptf_rawls1982_theta_33_functions, calc_ptf_rawls1982_theta_33_types,
                         3, 1) < 0)
        return -1;
    if (ptfkit_add_ufunc(module, "calc_ptf_rawls1982_full_wrc",
                         calc_ptf_rawls1982_full_wrc_functions, calc_ptf_rawls1982_full_wrc_types,
                         5, 12) < 0)
        return -1;
    return 0;
}
