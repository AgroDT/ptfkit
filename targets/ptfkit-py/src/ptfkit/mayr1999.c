...
static void calc_ptf_mayr1999_loop(char **args, const npy_intp *dimensions, const npy_intp *steps, void *data) {
    npy_intp index;
...
static char calc_ptf_mayr1999_types[] = { NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE, NPY_DOUBLE };

int ptfkit_register_mayr1999(PyObject *module) {
    if (ptfkit_add_ufunc(module, "calc_ptf_mayr1999", calc_ptf_mayr1999_functions, calc_ptf_mayr1999_types, 5, 3) < 0) return -1;
    return 0;
}
